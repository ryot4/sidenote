...
First of all, you need to prepare it with `init` command.
...
For the full list of commands, options and environment varibles, see `sidenote -h` and `sidenote <command> -h`.
